...
class Data:
    def __init__(self):
        self.filePaths = ["../../Data/ListWidgetData/lstWidOpen.csv", "../../Data/ListWidgetData/lstWidProgress.csv",
                          "../../Data/ListWidgetData/lstWidTested.csv", "../../Data/ListWidgetData/lstWidReopen.csv",
                          "../../Data/ListWidgetData/lstWidClosed.csv"]

        if not os.path.isfile("../../Data/ListWidgetData/together.csv"):
            with open("../../Data/ListWidgetData/together.csv", 'w', encoding='utf-8') as file:
    ...
    def newWidgetStoreData(self, heading: str, description: str, color: str, tagName: str, whichList: int):
        ...
        allData = pd.read_csv("../../Data/ListWidgetData/together.csv")
        ...
        togetherCsvData.to_csv('../../Data/ListWidgetData/together.csv')
    ...
    def switchListWidgetsItem(self, getIn: bool = False, correctData: bool = False):
        print(self.rowRemovedIndex, self.rowInsertedIndex, self.insertedToList, self.removedFromList)
        if getIn:
            print('switch check')
    ...
    def returnTopFiveItems(self) -> list:
        df = pd.read_csv("../../Data/ListWidgetData/together.csv")
